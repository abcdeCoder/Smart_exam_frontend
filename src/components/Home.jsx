...
import video from "./static/images/videoplayback.mp4";
const api = {
...
function Home(props) {
  ...
  return (
    <>
      ...
      <div className="home">
      <Typography className="help" variant="h4">Hello, welcome to Smart Exam!</Typography>
      <br/>
      ...
      {!props.token && <p className="lead text-muted">
        ...
        <video src={video} width="600" height="600"   autoplay="true" className="vid"/>
     </div>
